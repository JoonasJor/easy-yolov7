...
class Tello:
    ...
    RETRY_COUNT = 6  # number of retries after a failed command
    ...
    def __init__(self,
        ...
        if not threads_initialized:
            ...
            client_socket.bind((self.interface_ip, 0))
        ...
        self.LOGGER.info("Tello instance was initialized. Host: '{}'. Port: '{}'. Interface: '{}'".format(host, Tello.CONTROL_UDP_PORT, self.interface_ip, self.interface_ip))
